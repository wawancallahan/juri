        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-white">Kategori Peserta</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active text-white">Kategori Peserta</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="mb-3">
                        <a href="tambah_kategori_peserta.php" class="btn btn-primary">Tambah Kategori Peserta</a>
                    </div>

                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Kategori Peserta</h3>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($kategoriPesertaItems as $index => $kategoriPesertaItem) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_kategori_peserta.php?id=<?php echo $kategoriPesertaItem['id'] ?>" class="btn btn-warning btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                
                                                <a href="hapus_kategori_peserta_proses.php?id=<?php echo $kategoriPesertaItem['id'] ?>" class="btn btn-danger btn-sm">

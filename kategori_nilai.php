        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-white">Kategori Nilai</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item text-white"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active text-white">Kategori Nilai</li>
                        </ol>
                    </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="mb-3">
                        <a href="tambah_kategori_nilai.php" class="btn btn-primary">Tambah Kategori Nilai</a>
                    </div>

                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Kategori Nilai</h3>
                        </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach ($kategoriNilaiItems as $index => $kategoriNilaiItem) { ?>
                                        <tr>
                                            <td><?php echo $index + 1 ?></td>
                                            <td><?php echo $kategoriNilaiItem['nama'] ?></td>
                                            <td>
                                                <a href="edit_kategori_nilai.php?id=<?php echo $kategoriNilaiItem['id'] ?>" class="btn btn-warning btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                
                                                <a href="hapus_kategori_nilai_proses.php?id=<?php echo $kategoriNilaiItem['id'] ?>" class="btn btn-danger btn-sm">

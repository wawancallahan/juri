                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach ($userItems as $index => $userItem) { ?>
                                        <tr>
                                            <td><?php echo $index + 1 ?></td>
                                            <td><?php echo $userItem['nama'] ?></td>
                                            <td><?php echo $userItem['username'] ?></td>
                                            <td><?php echo ucwords($userItem['role']) ?></td>
                                            <td>
                                                <a href="edit_user.php?id=<?php echo $userItem['id'] ?>" class="btn btn-warning btn-sm">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>

                                                <?php if ($userItem['role'] !== "admin") { ?>
                                                    <a href="hapus_user_proses.php?id=<?php echo $userItem['id'] ?>" class="btn btn-danger btn-sm">

        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-white">User</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <form action="edit_user_proses.php" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control" placeholder="Username" value="<?php echo $item['username'] ?>" required>
                                </div>

                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="text" name="password" class="form-control" placeholder="Password">
                                    <p><i>* Silahkan isi password, jika ingin mengubah password anda!</i></p>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role" id="" class="form-control" required>
                                        ...
                                        <option value="admin" <?php echo $item['role'] == 'admin' ? 'selected' : null ?>>Admin</option>
                                        <option value="juri" <?php echo $item['role'] == 'juri' ? 'selected' : null ?>>Juri</option>
                                    </select>
                                </div>

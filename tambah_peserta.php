            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="tambah_peserta_proses.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tanggal_lahir" class="form-control" data-toggle="datepicker" placeholder="Tanggal Lahir" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori_peserta_id" id="" class="form-control" required>
                                        ...
                                        <?php foreach ($kategoriPesertaItems as $kategoriPesertaItem) { ?> 
                                            <option value="<?php echo $kategoriPesertaItem['id'] ?>"><?php echo $kategoriPesertaItem['nama'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>

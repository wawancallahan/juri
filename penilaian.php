...
$pesertaItems = array_reduce($pesertaItems, function ($output, $item) {
    $output[$item['kategori_peserta_id']][] = $item;
                                    ...
                                    <div class="row">
                                        <?php foreach ($pesertaItemsChunk as $pesertaItem) { ?>
                                            <div class="col-md-4 mb-3">
                                                <a href="tambah_penilaian.php?id=<?php echo $pesertaItem['id'] ?>" class="d-block">
